#!/usr/bin/python
# -*- coding: utf-8 -*-
# Created by MNASR "popking159" "odem2014"
# <widget source="session.CurrentService" render="LukaBoxImage" position="1103,642" size="550,155" alphatest="on" scale="1" zPosition="99" />
from Components.Renderer.Renderer import Renderer
from enigma import ePixmap, loadPNG
import os

class LukaBoxImage(Renderer):
    def __init__(self):
